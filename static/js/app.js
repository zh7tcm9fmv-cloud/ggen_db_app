...
function btFeaturedMergedCell(units,chars){return'<td class="bt-feat-stack-cell">'+'<div class="bt-feat-stack">'+'<div class="bt-feat-block"><div class="bt-feat-sub">'+esc(t('bt_col_units'))+'</div>'+btFeaturedCell(units,48)+'</div>'+'<div class="bt-feat-block"><div class="bt-feat-sub">'+esc(t('bt_col_chars'))+'</div>'+btFeaturedCell(chars,48)+'</div>'+'</div>'+'</td>'}
