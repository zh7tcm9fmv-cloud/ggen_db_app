...
function ensureRankingTopControlEnhancements(){const row=document.querySelector('#panel-ranking .ranking-sort-row');if(!row)return;const dirBtn=document.getElementById('rankingDirBtn');const html=`<button type="button" class="ranking-view-btn" data-ranking-view="list" onclick="setRankingViewMode('list')" title="List"><img class="ranking-view-icon" src="${imgUrl('/static/images/UI/UI_Common_BtnIcon_Sort_Nega.webp')}" alt="" loading="lazy" decoding="async" onerror="this.style.display='none'"><span class="ranking-view-txt">List</span></button><button type="button" class="ranking-view-btn" data-ranking-view="podium" onclick="setRankingViewMode('podium')" title="Podium Chart"><img class="ranking-view-icon" src="${imgUrl('/static/images/UI/UI_Common_BtnIcon_Sort_Posi.webp')}" alt="" loading="lazy" decoding="async" onerror="this.style.display='none'"><span class="ranking-view-txt">Podium</span></button>`;const ex=row.querySelector('.ranking-view-toggle');if(ex){ex.innerHTML=html;return}const wrap=`<div class="ranking-view-toggle" role="group" aria-label="Ranking view mode">${html}</div>`;if(dirBtn)dirBtn.insertAdjacentHTML('beforebegin',wrap);else row.insertAdjacentHTML('beforeend',wrap)}
