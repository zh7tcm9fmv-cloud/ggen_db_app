...
function syncStageSourceToolbar(){const src=S.stages.source||'eternal';const diff=document.getElementById('stageDiffWrap');if(diff)diff.style.display=(src==='eternal'||src==='tower_stage')?'':'none';const bE=document.getElementById('stageSourceEternalBtn');const bT=document.getElementById('stageSourceTowerBtn');const bS=document.getElementById('stageSourceScoreBtn');const bP=document.getElementById('stageSourceSpecialBtn');if(bE){bE.classList.toggle('active',src==='eternal');bE.setAttribute('aria-pressed',src==='eternal'?'true':'false')}if(bT){bT.classList.toggle('active',src==='tower_stage');bT.setAttribute('aria-pressed',src==='tower_stage'?'true':'false')}if(bS){bS.classList.toggle('active',src==='score_attack');bS.setAttribute('aria-pressed',src==='score_attack'?'true':'false')}if(bP){bP.classList.toggle('active',src==='special_stage');bP.setAttribute('aria-pressed',src==='special_stage'?'true':'false')}}
function setStageBrowseSource(mode){if(mode!=='eternal'&&mode!=='tower_stage'&&mode!=='score_attack'&&mode!=='special_stage')return;if((S.stages.source||'eternal')===mode)return;S.stages.source=mode;syncStageSourceToolbar();scheduleBrowseListReload('stages')}
