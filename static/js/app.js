...
function btVoteTogglePick(gid,key){const list=btVotePickList(gid);const i=list.indexOf(key);if(i>=0)list.splice(i,1);else{if(list.length>=BT_VOTE_MAX){alert(t('bt_vote_max'));return}list.push(key)}}
