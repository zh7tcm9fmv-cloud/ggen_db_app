...
const _origRenderCharShell=renderCharShell;
renderCharShell=function(d){let h=_origRenderCharShell(d);if(!(d&&d.ranking_available))return h;h=h.replace('<div class="header-stats-wrapper" id="detailStatsWrapper"></div>',`<div class="header-stats-wrapper">${renderDetailRankingToggle(d,'character')}<div id="detailStatsWrapper"></div></div>`);return h};
const _origRenderUnitShell=renderUnitShell;
renderUnitShell=function(d){let h=_origRenderUnitShell(d);if(!(d&&d.ranking_available))return h;h=h.replace('<div class="header-stats-wrapper">${lb}<div id="detailStatsWrapper"></div></div>',`<div class="header-stats-wrapper">${lb}${renderDetailRankingToggle(d,'unit')}<div id="detailStatsWrapper"></div></div>`);return h};
