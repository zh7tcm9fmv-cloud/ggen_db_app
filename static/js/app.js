...
function btVoteThumbBlock(thumbHtml,voteMode){if(!voteMode)return'<div class="lr-card-thumb">'+thumbHtml+'</div>';return'<div class="bt-vote-thumb-wrap"><div class="lr-card-thumb">'+thumbHtml+'</div>'+btVoteSelectOverlay()+'</div>'}
