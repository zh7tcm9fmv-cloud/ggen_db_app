...
Object.assign(T.EN,{tab_banner_timeline:'Unit Assembly',bt_view_table:'Table',bt_view_timeline:'Timeline',bt_scroll_top:'Back to top',bt_col_banner:'Unit Assembly',bt_col_featured:'Featured',bt_col_units:'Featured units',bt_col_chars:'Featured characters',bt_col_supporters:'Featured supporters',bt_col_start:'Start (JST)',bt_col_end:'End (JST)',bt_col_duration:'Duration',bt_empty:'No schedule data.',bt_sort_start_hint:'Click to sort by start date (▼ newest first · ▲ oldest first).',sort_desc:'Sort descending',sort_asc:'Sort ascending',bt_vote_mode_on:'Voting mode on',bt_vote_mode_off:'Voting mode off',bt_vote_submit:'VOTE!',bt_vote_all:'I want them all!!',bt_vote_skip:'I will skip this pool',bt_vote_total:'Total votes:',bt_vote_pick_hint:'Select up to 2 options, then vote.',bt_vote_done:'Thanks — your vote was recorded.',bt_vote_err:'Could not submit vote. Try again.',bt_vote_max:'You can only pick 2 options per release.',bt_vote_count:'votes',bt_vote_mode_caption_1:'Which new unit(s) are you aiming for?',bt_vote_mode_caption_2:'You can cast up to 2 votes.'});Object.assign(T.TW,{tab_banner_timeline:'機體補給',bt_view_table:'表格',bt_view_timeline:'時間線',bt_scroll_top:'回頂端',bt_col_banner:'機體補給',bt_col_featured:'精選',bt_col_units:'精選機體',bt_col_chars:'精選角色',bt_col_supporters:'精選支援',bt_col_start:'開始（JST）',bt_col_end:'結束（JST）',bt_col_duration:'期間',bt_empty:'尚無轉蛋資料。',bt_sort_start_hint:'按開始日期排序（▼ 由新至舊 · ▲ 由舊至新）。',sort_desc:'由大到小排序',sort_asc:'由小到大排序',bt_vote_mode_on:'投票模式',bt_vote_mode_off:'關閉投票',bt_vote_submit:'投票！',bt_vote_all:'我全都要！！',bt_vote_skip:'這池跳過',bt_vote_total:'總票數：',bt_vote_pick_hint:'最多選 2 項後投票。',bt_vote_done:'已記錄你的投票。',bt_vote_err:'投票失敗，請重試。',bt_vote_max:'每個轉蛋最多選 2 項。',bt_vote_count:'票',bt_vote_mode_caption_1:'你想抽哪些新機體？',bt_vote_mode_caption_2:'每個轉蛋最多可投 2 票。'});Object.assign(T.HK,{tab_banner_timeline:'機體補給',bt_view_table:'表格',bt_view_timeline:'時間線',bt_scroll_top:'回頂端',bt_col_banner:'機體補給',bt_col_featured:'精選',bt_col_units:'精選機體',bt_col_chars:'精選角色',bt_col_supporters:'精選支援',bt_col_start:'開始（JST）',bt_col_end:'結束（JST）',bt_col_duration:'期間',bt_empty:'尚無扭蛋資料。',bt_sort_start_hint:'按開始日期排序（▼ 由新至舊 · ▲ 由舊至新）。',sort_desc:'由大到小排序',sort_asc:'由小到大排序',bt_vote_mode_on:'投票模式',bt_vote_mode_off:'關閉投票',bt_vote_submit:'投票！',bt_vote_all:'我全都要！！',bt_vote_skip:'這池跳過',bt_vote_total:'總票數：',bt_vote_pick_hint:'最多選 2 項後投票。',bt_vote_done:'已記錄你的投票。',bt_vote_err:'投票失敗，請重試。',bt_vote_max:'每個轉蛋最多選 2 項。',bt_vote_count:'票',bt_vote_mode_caption_1:'你想抽哪些新機體？',bt_vote_mode_caption_2:'每個扭蛋最多可投 2 票。'});const STAT_NAME_MAP={EN:{},TW:{'Ranged':'射擊','Melee':'格鬥','Awaken':'覺醒','Defense':'守備力','Reaction':'反應','HP':'HP','EN':'EN','Attack':'攻擊力','ATK':'攻擊力','DEF':'守備力','MOB':'機動力','Mobility':'機動力','Move':'移動力'}};
...
const BT_VOTE_UI={mission:'/static/images/UI/UI_Home_Menu_Icon_Mission.webp',cursor:'/static/images/UI/UI_Battle_MapUI_Supporter_TargetAreaCursor.webp',check:'/static/images/UI/UI_Common_BtnIcon_Check_Posi_S.webp',voteBtn:'/static/images/UI/UI_StageTop_Button_Lsize_DesignLine_2.webp',poolAll:'/static/images/UI/IMG_StageTop_MaterialStage.webp'};const BT_VOTE_MAX=2;const BT_VOTE_DISABLED_GASHA_IDS=new Set(['2504100101','2604300101']);
...
function btVoteEnabledForGid(gid){const g=String(gid||'');return g&&g!=='0'&&!BT_VOTE_DISABLED_GASHA_IDS.has(g)}
...
function btVotePickList(gid){if(!S.btVotePick)S.btVotePick={};if(!S.btVotePick[gid])S.btVotePick[gid]=[];return S.btVotePick[gid]}
...
function btVoteModeCaptionHtml(){return esc(t('bt_vote_mode_caption_1'))+'<br>'+esc(t('bt_vote_mode_caption_2'))}
function btVoteModeBtnMarkup(btnId){const voteOn=!!S.btVoteMode;return'<button type="button" class="bt-vote-mode-btn" id="'+btnId+'" aria-pressed="'+(voteOn?'true':'false')+'" title="'+escAttr(voteOn?t('bt_vote_mode_on'):t('bt_vote_mode_off'))+'" onclick="toggleBtVoteMode()"><img src="'+escAttr(btVoteUiImg(BT_VOTE_UI.mission))+'" alt="" width="26" height="26" decoding="async"></button>'}
...
function btVoteSubmitBtn(gid,enabled){const dis=enabled?'':' disabled';return'<div class="bt-vote-submit-wrap"><button type="button" class="bt-vote-submit" data-gasha-id="'+escAttr(gid)+'"'+dis+'><img class="bt-vote-submit-bg" src="'+escAttr(btVoteUiImg(BT_VOTE_UI.voteBtn))+'" alt="" decoding="async" aria-hidden="true"><span class="bt-vote-submit-label">'+esc(t('bt_vote_submit'))+'</span></button></div>'}
function btVoteExtraCard(gid,key,label,skip){const sel=btVotePickList(gid).includes(key);const cls='bt-vote-extra-thumb bt-vote-tile'+(skip?' bt-vote-extra--skip':'')+(sel?' is-vote-selected':'');return'<div class="'+cls+'" role="button" tabindex="0" data-gasha-id="'+escAttr(gid)+'" data-vote-key="'+escAttr(key)+'" aria-pressed="'+(sel?'true':'false')+'"><div class="bt-vote-extra-ic-wrap"><img class="bt-vote-extra-ic" src="'+escAttr(btVoteUiImg(BT_VOTE_UI.poolAll))+'" alt="" loading="lazy" decoding="async">'+btVoteSelectOverlay()+'</div><div class="lr-card-name">'+esc(label)+'</div></div>'}
...
function btFeaturedMergedCell(units,chars,supporters,gid,b,voteModeOverride){const voteOk=btVoteEnabledForGid(gid);const voteMode=(voteModeOverride!=null?!!voteModeOverride:!!S.btVoteMode)&&voteOk;const sups=supporters&&supporters.length?supporters:null;let inner='';if(voteMode&&gid)inner+='<div class="bt-feat-block bt-feat-block--vote-extras">'+btVoteExtrasStrip(gid)+'</div>';inner+='<div class="bt-feat-block"><div class="bt-feat-sub">'+esc(t('bt_col_units'))+'</div>'+btFeaturedCell(units,62,gid,voteMode)+'</div>'+'<div class="bt-feat-block"><div class="bt-feat-sub">'+esc(t('bt_col_chars'))+'</div>'+btFeaturedCell(chars,62,gid,voteMode)+'</div>';if(sups)inner+='<div class="bt-feat-block"><div class="bt-feat-sub">'+esc(t('bt_col_supporters'))+'</div>'+btFeaturedCell(sups,62,gid,voteMode)+'</div>';const picks=voteMode&&gid?btVotePickList(gid):[];const voteBtn=voteMode?btVoteSubmitBtn(gid,picks.length>0):'';const rowCls=voteOk?'':' bt-vote-row--disabled';return'<td class="bt-feat-stack-cell'+rowCls+'" data-gasha-id="'+escAttr(gid||'')+'">'+'<div class="bt-feat-stack">'+inner+'</div>'+voteBtn+'</td>'}
...
async function fetchBtVoteTotals(){try{const r=await fetch('/api/banner_timeline/votes',{credentials:'same-origin',cache:'no-store'});if(!r.ok)return;const d=await r.json();S.btVoteTotals=d.totals||{}}catch(_){}}
function toggleBtVoteMode(){if(!S.btCacheData)return;const root=document.getElementById('bannerTimelineRoot');if(!root||!root.querySelector('.bt-table'))return;document.querySelectorAll('.bt-vote-mode-btn').forEach(b=>{b.disabled=true});S.btVoteMode=!S.btVoteMode;const finish=()=>{document.querySelectorAll('.bt-vote-mode-btn').forEach(b=>{b.disabled=false});requestAnimationFrame(()=>{armBannerTimelineScrollFabBaseline();updateBannerTimelineScrollFabVisibility()})};const apply=()=>{if(!btSwapVoteTbody())renderBannerTimeline(S.btCacheData);finish()};requestAnimationFrame(apply)}
function btVoteIsPoolExclusive(key){return key==='all'||key==='skip'}
function btVoteTogglePick(gid,key){if(!btVoteEnabledForGid(gid))return;const list=btVotePickList(gid);const i=list.indexOf(key);if(i>=0){list.splice(i,1);return}if(btVoteIsPoolExclusive(key)){list.length=0;list.push(key);return}for(let j=list.length-1;j>=0;j--){if(btVoteIsPoolExclusive(list[j]))list.splice(j,1)}if(list.length>=BT_VOTE_MAX){alert(t('bt_vote_max'));return}list.push(key)}
...
function btVoteRefreshRowUi(gid){if(!btVoteEnabledForGid(gid))return;const tr=btVoteRowEl(gid);if(!tr||!S.btCacheData)return;const b=(S.btCacheData.banners||[]).find(x=>String(x.gasha_id)===gid);if(!b||!btVoteEnabledForBanner(b))return;const picks=btVotePickList(gid);tr.querySelectorAll('.bt-vote-tile[data-vote-key]').forEach(el=>{const k=el.getAttribute('data-vote-key');const on=picks.includes(k);el.classList.toggle('is-vote-selected',on);el.setAttribute('aria-pressed',on?'true':'false')});const btn=tr.querySelector('.bt-vote-submit');if(btn)btn.disabled=picks.length<1;const sched=tr.querySelector('.bt-banner-sched');if(sched){const old=sched.querySelector('.bt-vote-results');if(old)old.remove();const tmp=document.createElement('div');tmp.innerHTML=btVoteResultsHtml(gid,b);const neu=tmp.firstElementChild;if(neu)sched.appendChild(neu)}btInvalidateVoteTbodyCache()}
async function btSubmitVote(gid){if(!btVoteEnabledForGid(gid))return;const picks=btVotePickList(gid);if(!picks.length)return;const tr=btVoteRowEl(gid);const btn=tr?tr.querySelector('.bt-vote-submit'):null;if(btn)btn.disabled=true;try{const r=await fetch('/api/banner_timeline/vote',{method:'POST',credentials:'same-origin',headers:{'Content-Type':'application/json'},body:JSON.stringify({gasha_id:gid,client_id:btVoteClientId(),choices:picks})});const d=await r.json().catch(()=>({}));if(!r.ok)throw new Error(d.error||'HTTP '+r.status);if(d.totals)S.btVoteTotals=Object.assign({},S.btVoteTotals||{}, {[gid]:d.totals});btVoteRefreshRowUi(gid);alert(t('bt_vote_done'))}catch(e){alert(t('bt_vote_err')+' '+String(e));if(btn)btn.disabled=false}}
function btBindVoteDelegation(){const root=document.getElementById('bannerTimelineRoot');if(!root||root._btVoteBound)return;root._btVoteBound=1;root.addEventListener('click',ev=>{const sub=ev.target.closest('.bt-vote-submit');if(sub){ev.preventDefault();const gid=sub.getAttribute('data-gasha-id');if(gid&&btVoteEnabledForGid(gid))btSubmitVote(gid);return}if(!S.btVoteMode)return;const tile=ev.target.closest('.bt-vote-tile[data-vote-key]');if(!tile)return;ev.preventDefault();ev.stopPropagation();const gid=tile.getAttribute('data-gasha-id');const key=tile.getAttribute('data-vote-key');if(!gid||!key||!btVoteEnabledForGid(gid))return;btVoteTogglePick(gid,key);btVoteRefreshRowUi(gid)})}
async function loadBannerTimeline(){const root=document.getElementById('bannerTimelineRoot');const load=document.getElementById('bannerTimelineLoading');if(!root)return;if(S.currentTab==='banner_timeline')armBannerTimelineScrollFabBaseline();const cacheKey=S.lang;if(S.btCacheKey===cacheKey&&S.btCacheData){await fetchBtVoteTotals();renderBannerTimeline(S.btCacheData);return}if(load)load.style.display='flex';try{const[r1,r2]=await Promise.all([fetch('/api/banner_timeline?lang='+encodeURIComponent(S.lang),{credentials:'same-origin'}),fetch('/api/banner_timeline/votes',{credentials:'same-origin',cache:'no-store'})]);if(!r1.ok)throw new Error('HTTP '+r1.status);const data=await r1.json();if(r2.ok){const vd=await r2.json();S.btVoteTotals=vd.totals||{}}S.btCacheKey=cacheKey;S.btCacheData=data;if(S.btVotePick){BT_VOTE_DISABLED_GASHA_IDS.forEach(id=>{delete S.btVotePick[id]})}renderBannerTimeline(data)}catch(e){S.btCacheKey=null;S.btCacheData=null;root.innerHTML='<div class="empty-state"><div class="empty-state-text">'+esc(String(e))+'</div></div>';requestAnimationFrame(()=>{armBannerTimelineScrollFabBaseline();updateBannerTimelineScrollFabVisibility()})}finally{if(load)load.style.display='none'}}
...
function initBannerTimelineExtras(){if(S._bannerTimelineExtras)return;S._bannerTimelineExtras=1;window.addEventListener('scroll',updateBannerTimelineScrollFabVisibility,{passive:true});if(typeof S.btVoteMode!=='boolean')S.btVoteMode=false;if(!S.btVotePick)S.btVotePick={}}
