...
function tStat(name,ctx){const lang=S.lang;if((lang==='TW'||lang==='HK')&&ctx==='character'){const c=STAT_NAME_MAP_CHAR[lang];if(c&&c[name])return c[name]}const m=STAT_NAME_MAP[lang];return(m&&m[name])||name}
