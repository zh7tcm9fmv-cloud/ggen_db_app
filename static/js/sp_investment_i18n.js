...
(function (global) {
  ...
  const UI = {
    EN: {
      ...
      stats_note_unit: '{mode} board stats · ranked vs other {role} units',
      stats_note_pilot: 'SP-grown totals · specialty for MS matching: {specialty} · ranked vs other {role} characters',
    ...
    JA: {
      ...
      stats_note_unit: '{mode}ボードのステータス · 同タイプ（{role}）内での順位',
      stats_note_pilot: 'SP成長後の合計 · MSマッチ用専門：{specialty} · 同タイプ（{role}）内での順位',
    ...
    TW: {
      ...
      stats_note_unit: '{mode}看板能力值 · 與同類型（{role}）單位比較排名',
      stats_note_pilot: 'SP成長後合計 · MS匹配專長：{specialty} · 與同類型（{role}）角色比較排名',
    ...
    HK: {
      ...
      stats_heading: '能力值',
      stats_rank_within_role: '{role}內',
      stats_note_unit: '{mode}看板能力值 · 同類型（{role}）單位內排名',
      stats_note_pilot: 'SP成長後合計 · MS匹配專長：{specialty} · 同類型（{role}）角色內排名',
