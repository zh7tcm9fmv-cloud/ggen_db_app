...
(function (global) {
  ...
  const UI = {
    EN: {
      ...
      cp_toggle_title: 'Conditional Passive',
      cp_toggle_aria: 'Conditional Passive',
    ...
    JA: {
      ...
      cp_toggle_title: '条件付きパッシブ',
      cp_toggle_aria: '条件付きパッシブ',
      all_sources: 'すべての入手元',
      source_gacha: 'ユニット補給',
      source_event: 'その他',
      source_dev: '開発ユニット',
    ...
    TW: {
      ...
      cp_toggle_title: '條件式被動',
      cp_toggle_aria: '條件式被動',
      all_sources: '全部取得來源',
