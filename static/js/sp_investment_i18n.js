...
(function (global) {
  ...
  const UI = {
    EN: {
      ...
      source_gacha: 'Unit Assembly / gacha',
      source_event: 'Event / other',
    ...
    JA: {
      ...
      all_sources: 'すべての入手経路',
      source_gacha: 'ユニット組み立て / ガチャ',
      source_event: 'イベント / その他',
      source_dev: '開発',
      no_tag_filter: 'タグフィルタなし',
      no_er_filter: 'エターナルロード Expert フィルタなし',
      er_filter_title: 'エターナルロード Expert',
      tag_filter_title: 'タグ',
      source_filter_title: '入手経路',
      foot:
