...
def _pick_node_thumb(resource_id, size_type, content_type, *, detail=False):
    """E Simulator thumbs: list/browse always *_02; Size-L detail may use *_l + report BG."""
    ...
    # Stage detail for Size-L keeps the square *_l hero; browse list uses colored *_02.
        ...
        for n in d_nodes:
            ...
            for c in n_contents:
                ...
                entry = {
                    ...
                    'thumb': pub(_pick_node_thumb(res, size_type, ctype, detail=False)),
